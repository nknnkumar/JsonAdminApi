                                    ...
                                    if ("enteronclient" in jVarLocalCurrentTarget.dataset) {
                                        if (jVarLocalCurrentTarget.dataset.enteronclient === "true") {
                                            ...
                                            for (let index = 0; index < jVarLocalTableFooterCells.length; index++) {
                                                jVarLocalClientEval = this.Api.UserData.Table.Footer.KeyPress.CommonFuncs.EnterOnClient.ForLoopFunc({ injVarClientEval: jVarLocalClientEval, injVarTableFooterCells: jVarLocalTableFooterCells, inIndex: index });
                                            };
                                            ...
                                            console.log("LocalStorage-------------------", jVarLocalLocalStorageObject);
                ...
                CommonFuncs: {
                    ShowToastFuncs: {
                        ForDataList: () => {
                            ...
                            var toastLiveExample = document.getElementById('liveToastForDataList');

                            if (toastLiveExample !== null) {
                                var toast = new bootstrap.Toast(toastLiveExample, { delay: 5000 });
